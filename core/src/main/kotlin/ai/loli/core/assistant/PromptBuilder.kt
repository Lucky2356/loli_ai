...
object PromptBuilder {
    ...
    fun build(
        ...
        appendLine(
            ...
            Правила:
            1. Категории расходов: Продукты, Кафе и рестораны, Транспорт, Дом и ЖКХ, Связь и интернет, Подписки, Здоровье, Красота, Одежда и обувь, Развлечения, Подарки, Образование, Путешествия, Спорт, Дети, Питомцы, Электроника, Другое.
